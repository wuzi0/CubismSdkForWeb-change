...
*/
   ...
   // 拖动更改
      // 通过拖动来调整面部方向
      this._model.addParameterValueById(this._idParamAngleX, this._dragX*3);  // 将值加到-30至30
      this._model.addParameterValueById(this._idParamAngleY, this._dragY*3);
      this._model.addParameterValueById(this._idParamAngleZ, this._dragX * this._dragY * -3);

      // 通过拖动来调整身体方向
      this._model.addParameterValueById(this._idParamBodyAngleX, this._dragX * 2);  // -10から10の値を加える
